...
public class GerenciamentoFolha{
    ...
    public void ExtratoGeral(){
        for (FuncionarioCLT funcionarios : funcionarioCLT) {
            if(funcionarios.getValeRefeicao() != 0.0 ) {
                ...
                System.out.println("Funcionario "+ funcionarios.getNome()+ " com o CPF "+ funcionarios.getCpf() +" está com um salário inferior a R$ 1320");
            }
        }
    ...
    public void TotalDaFolha(){
        ...
        System.out.println("Valor total da folha é: " + total);
    }
